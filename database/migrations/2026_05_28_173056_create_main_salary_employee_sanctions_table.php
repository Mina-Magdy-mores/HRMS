...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employee_deductions', function (Blueprint $table) {
            $table->id();
            ...
            $table->foreign('finance_monthly_calendar_id', 'fk_deductions_calendar') // اسم قصير
                ->references('id')
    ...
    {
        Schema::dropIfExists('main_salary_employee_deductions');
    }
};
