...
return new class extends Migration
{
    ...
    {
        Schema::create('main_salary_employee_deduction_types', function (Blueprint $table) {
            $table->id();
            $table->foreignId('main_salary_employee_id');
            $table->foreign('main_salary_employee_id', 'fk_deduction_main_salary_employee')
                ->references('id')
            ...
            $table->foreign('finance_monthly_calendar_id', 'fk_deductions_types_calendar')
                ->references('id')
                ->on('finance_monthly_calendars')
                ->onUpdate('cascade');
            $table->foreignId('deduction_type_id');
            $table->foreign('deduction_type_id', 'fk_deduction_type')
                ->references('id')
                ->on('deduction_types')
                ->onUpdate('cascade');
    ...
    {
        Schema::dropIfExists('main_salary_employee_deduction_types');
    }
};
