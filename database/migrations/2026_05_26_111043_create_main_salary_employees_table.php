...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('main_salary_employees', function (Blueprint $table) {
            ...
            $table->decimal('employee_total_allowance', 15, 2)->nullable()->default(0)->comment('Total allowance of the employee');
            ...
            $table->decimal('employee_absence_days_counter', 15, 2)->nullable()->default(0)->comment('Number of absence days of the employee');
            $table->decimal('employee_absence_payment_per_day', 15, 2)->nullable()->default(0)->comment('Payment per absence day of the employee');
            ...
            $table->decimal('total_deductions', 15, 2)->nullable()->default(0)->comment('Total deductions');
            ...
            $table->decimal('employee_penalty_days_counter_type1', 15, 2)->nullable()->default(0)->comment('Number of penalty days of the employee');
            $table->decimal('employee_penalty_payment_per_day_type1', 15, 2)->nullable()->default(0)->comment('Payment per penalty day of the employee');
            $table->decimal('employee_penalty_days_counter_type2', 15, 2)->nullable()->default(0)->comment('Number of penalty days of the employee for finger print');
            $table->decimal('employee_penalty_payment_per_day_type2', 15, 2)->nullable()->default(0)->comment('Payment per penalty day of the employee for finger print');
            $table->decimal('employee_penalty_days_counter_type3', 15, 2)->nullable()->default(0)->comment('Number of penalty days of the employee for absence');
            $table->decimal('employee_penalty_payment_per_day_type3', 15, 2)->nullable()->default(0)->comment('Payment per penalty day of the employee for absence');
