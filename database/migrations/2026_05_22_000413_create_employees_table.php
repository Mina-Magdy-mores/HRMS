...
return new class extends Migration {
    public function up(): void
    {
        Schema::create('employees', function (Blueprint $table) {
            ...
            // بيانات الموظف الرئيسية (Tab: أساسي)
            $table->integer('employee_code')->unique()->comment('Employee Code unique identifier');
            $table->string('fingerprint_code')->unique()->nullable()->comment('Fingerprint Code unique identifier');
            $table->string('name');
            ...
            $table->tinyInteger('driving_license')->nullable()->default(0)->comment('1: Yes, 0: No');
            $table->foreignId('driving_license_type_id')->nullable()->constrained('driving_license_types')->cascadeOnUpdate();
            $table->string('driving_license_number')->nullable();

            // الحالة العسكرية (Tab: عسكري)
            ...
            // الوظيفة والتعليم (Tab: وظيفة وتعليم)
            ...
            $table->tinyInteger('employment_status')->comment('1: Active, 0: Inactive');
            $table->tinyInteger('fixed_shift')->nullable()->default(0);
            ...
            // المالي والتأمين (Tab: مالي وتأمين)
            ...
            $table->tinyInteger('fixed_allowance')->nullable()->default(0);
            $table->tinyInteger('has_attendance')->nullable()->default(1)->comment('1: Yes, 0: No');
            $table->tinyInteger('vacation_formula')->nullable()->default(0);
            $table->tinyInteger('active_for_vacation')->nullable()->default(0);
            $table->tinyInteger('has_sensitive_data')->nullable()->default(0);

            // بيانات إضافية (Tab: بيانات إضافية)
            ...
            $table->foreignId('language_id')->nullable()->constrained('languages')->cascadeOnUpdate();
            ...
            $table->text('urgent_contact_details')->nullable();
