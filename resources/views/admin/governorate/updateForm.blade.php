        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">تعديل محافظة</span>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $governorate->status == 1 ? 'مفعل' : 'معطل' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ optional($governorate->addedBy)->name ?? '---' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ optional($governorate->updatedBy)->company_id ??
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="country_id"
                                ...
                                <option value="{{ $country->id }}" {{ old('country_id', $governorate->country_id) ==
                                    $country->id ? 'selected' : '' }}>
                                    {{ $country->name }}
                                </option>
                                @endforeach
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}">
                                <option value="1" {{ old('status', $governorate->status) == 1 ? 'selected' : '' }}>مفعل
                                </option>
                                <option value="0" {{ old('status', $governorate->status) == 0 ? 'selected' : '' }}>معطل
                                </option>
                            </select>
