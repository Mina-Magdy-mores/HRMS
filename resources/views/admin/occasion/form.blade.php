        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">إضافة مناسبة جديدة</span>
                    <span class="info-box-number">مناسبة</span>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary card-outline shadow">
        ...
        <form action="{{ route('admin.occasions.store') }}" method="POST">
            ...
            <div class="card-body">
                ...
                @endif
                @if (session('error'))
                <div class="ale rt alert-danger alert-dismissible fade show">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" step="0.01" name="days_count" value="{{ old('days_count') }}"
