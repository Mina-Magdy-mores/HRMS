    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">عدد الإدارات</span>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">الإدارات المفعلة</span>
                    <span class="info-box-number">{{ $departments->where('status', 1)->count() }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">الإدارات المعطلة</span>
                    <span class="info-box-number">{{ $departments->where('status', 0)->count() }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">آخر إدارة تمت إضافتها</span>
                    <span class="info-box-number">{{ $lastDepartmentLabel }}</span>
                </div>
            </div>
        </div>
