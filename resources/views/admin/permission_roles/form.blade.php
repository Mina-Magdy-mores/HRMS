        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">إضافة دور جديد</span>
                    <span class="info-box-number">جديد</span>
                </div>
            </div>
        </div>
                    ...
                    @foreach($mainMenus as $mainMenu)
                        <div class="col-12 mb-4">
                            <div class="card card-outline card-primary shadow-sm">
                                <div class="card-header bg-light d-flex align-items-center justify-content-between py-2">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" name="permissions_main[]" value="{{ $mainMenu->id }}" 
                                               ...
                                               {{ is_array(old('permissions_main')) && in_array($mainMenu->id, old('permissions_main')) ? 'checked' : '' }}>
                                ...
                                <div class="card-body p-0 main-menu-body" id="main_menu_body_{{ $mainMenu->id }}" style="{{ is_array(old('permissions_main')) && in_array($mainMenu->id, old('permissions_main')) ? '' : 'display: none;' }}">
                                    <ul class="list-group list-group-flush mb-0">
                                        @foreach($mainMenu->subMenus as $subMenu)
                                            <li class="list-group-item d-flex flex-column flex-md-row justify-content-between align-items-md-center py-3">
                                                <div class="d-flex flex-column mb-2 mb-md-0" style="min-width: 250px;">
                                                    <div class="custom-control custom-checkbox mb-1">
                                                        <input type="checkbox" name="permissions_sub[]" value="{{ $subMenu->id }}"
                                                               ...
                                                               {{ is_array(old('permissions_sub')) && in_array($subMenu->id, old('permissions_sub')) ? 'checked' : '' }}>
                                                ...
                                                <div class="d-flex flex-wrap align-items-center sub-menu-actions-body" id="sub_menu_actions_{{ $subMenu->id }}" style="{{ is_array(old('permissions_sub')) && in_array($subMenu->id, old('permissions_sub')) ? 'display: flex; gap: 15px;' : 'display: none; gap: 15px;' }}">
                                                    @foreach($subMenu->actions as $action)
                                                        <div class="custom-control custom-checkbox mr-4 mb-1">
                                                            <input type="checkbox" name="permissions_action[]" value="{{ $action->id }}"
                                                                   ...
                                                                   {{ is_array(old('permissions_action')) && in_array($action->id, old('permissions_action')) ? 'checked' : '' }}>
