    ...
    <div class="row mb-4">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">بدلات تلقائية</span>
                    <span class="info-box-number">
                        {{ $mainSalaryEmployeeAllowances2->where('is_auto', 1)->count() }}
                    </span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">بدلات يدوية</span>
                    <span class="info-box-number">
                        {{ $mainSalaryEmployeeAllowances2->where('is_auto', 0)->count() }}
                    </span>
                </div>
            </div>
        </div>
