                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <select name="is_employee" id="is_employee" class="form-control {{ $errors->has('is_employee') ? 'is-invalid' : '' }}">
                                <option value="0" {{ old('is_employee', $admin->is_employee) == 0 ? 'selected' : '' }}>لا (مستخدم لوحة التحكم)</option>
                                <option value="1" {{ old('is_employee', $admin->is_employee) == 1 ? 'selected' : '' }}>نعم (موظف في الشركة)</option>
                            </select>
                    ...
                    <div class="col-md-4" id="allow_login_container" style="display: none;">
                        <div class="form-group">
                            ...
                            <select name="allow_login" class="form-control {{ $errors->has('allow_login') ? 'is-invalid' : '' }}">
                                <option value="1" {{ old('allow_login', $admin->allow_login) == 1 ? 'selected' : '' }}>نعم (مسموح بالدخول)</option>
                                <option value="0" {{ old('allow_login', $admin->allow_login) === 0 || old('allow_login', $admin->allow_login) === '0' ? 'selected' : '' }}>لا (حظر الدخول)</option>
                            </select>
                            ...
                            <select name="employee_id" id="employee_id" class="form-control {{ $errors->has('employee_id') ? 'is-invalid' : '' }}">
                                ...
                                @foreach($employees as $emp)
                                    <option value="{{ $emp->id }}" 
                                        ...
                                        {{ old('employee_id', $admin->employee_id) == $emp->id ? 'selected' : '' }}>
