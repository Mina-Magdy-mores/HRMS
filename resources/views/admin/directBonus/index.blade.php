...
@section('title', 'المكافآت المباشرة (خارج المرتب)')
...
@section('contentHeader')
    <i class="fas fa-gift text-primary"></i> المكافآت المباشرة (خارج المرتب)
@endsection

@section('contentHeaderActiveLink')
    <a class="active" href="{{ route('admin.direct-bonuses.index') }}">المكافآت المباشرة</a>
@endsection
        ...
        <div class="col-lg-4 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text font-weight-bold">إجمالي عمليات الصرف</span>
                    <span class="info-box-number text-lg text-primary">{{ $directBonuses->total() }} عملية</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text font-weight-bold">إجمالي مبالغ المكافآت</span>
                    <span class="info-box-number text-lg text-success">{{ number_format($directBonuses->sum('amount'), 2) }} ج.م</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text font-weight-bold">آخر مكافأة منصرفة</span>
                    <span class="info-box-number text-lg text-dark">
                        {{ $directBonuses->first() ? $directBonuses->first()->employee->name : 'لا يوجد' }}
                    </span>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary card-outline shadow">
        <div class="card-header bg-white">
            <h3 class="card-title font-weight-bold text-dark mt-1">
                <i class="fas fa-list-ul mr-1 text-primary"></i> سجل المكافآت المباشرة للموظفين
            </h3>
            <div class="card-tools">
                <a href="{{ route('admin.direct-bonuses.create') }}" class="btn btn-primary btn-sm shadow-sm font-weight-bold">
                    <i class="fas fa-plus-circle mr-1"></i> تسجيل مكافأة جديدة
                </a>
            </div>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function performSearch() {
                ...
                $.ajax({
                    url: "{{ route('admin.direct-bonuses.ajax-search') }}",
                    type: 'POST',
                    dataType: 'html',
                    cache: false,
                    data: {
