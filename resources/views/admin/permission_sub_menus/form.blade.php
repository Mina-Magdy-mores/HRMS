<div class="container-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">إضافة قائمة فرعية</span>
    ...
    <div class="card card-primary card-outline shadow">
        ...
        <form action="{{ route('admin.permission-sub-menus.store') }}" method="POST">
            @csrf
            <div class="card-body">
                @if ($errors->any())
                        ...
                        <div class="form-group">
                            ...
                            <select name="permission_main_menu_id" class="form-control {{ $errors->has('permission_main_menu_id') ? 'is-invalid' : '' }}">
                                ...
                                @foreach($mainMenus as $menu)
                                    <option value="{{ $menu->id }}" {{ old('permission_main_menu_id') == $menu->id ? 'selected' : '' }}>{{ $menu->name }}</option>
                                @endforeach
                            </select>
