...
<div class="container-fluid">
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">إضافة مهمة جديدة</span>
                    <span class="info-box-number">مهمة موظف</span>
                </div>
            </div>
        </div>
    ...
    <div class="card card-primary card-outline shadow">
        ...
        <form action="{{ route('admin.employee-tasks.store') }}" method="POST">
            @csrf
            <div class="card-body">
                @if ($errors->any())
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea name="content" rows="4"
                                ...
                                placeholder="أدخل تفاصيل ومحتوى المهمة بالكامل">{{ old('content') }}</textarea>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <label>الحالة المبدئية <span class="text-danger">*</span></label>
                            <select name="is_completed" class="form-control {{ $errors->has('is_completed') ? 'is-invalid' : '' }}">
                                <option value="0" {{ old('is_completed') == 0 ? 'selected' : '' }}>لم تبدأ</option>
                                <option value="1" {{ old('is_completed') == 1 ? 'selected' : '' }}>قيد العمل</option>
                                <option value="2" {{ old('is_completed') == 2 ? 'selected' : '' }}>منتهية ومكتملة</option>
                            </select>
