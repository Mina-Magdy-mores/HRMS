        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    <span class="info-box-text">تعديل دولة</span>
                    <span class="info-box-number">{{ $country->name }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ $country->status == 1 ? 'مفعل' : 'معطل' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ optional($country->addedBy)->name ?? '---' }}</span>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{ optional($country->updatedBy)->company_id ??
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control {{ $errors->has('status') ? 'is-invalid' : '' }}">
                                <option value="1" {{ old('status', $country->status) == 1 ? 'selected' : '' }}>مفعل
                                </option>
                                <option value="0" {{ old('status', $country->status) == 0 ? 'selected' : '' }}>معطل
                                </option>
                            </select>
