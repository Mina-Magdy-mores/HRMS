                            ...
                            <div class="tab-pane fade show active" id="tab-basic" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="marital_status"
                                                ...
                                                <option value="1"
                                                    {{ old('marital_status') == '1' ? 'selected' : '' }}>
                                                    أعزب</option>
                                                <option value="2"
                                                    {{ old('marital_status') == '2' ? 'selected' : '' }}>
                                                    متزوج</option>
                                                <option value="3"
                                                    {{ old('marital_status') == '3' ? 'selected' : '' }}>
                                                    مخطوب</option>
                                                <option value="4"
                                                    {{ old('marital_status') == '4' ? 'selected' : '' }}>
                                                    أرمل</option>
                                                <option value="5"
                                                    {{ old('marital_status') == '5' ? 'selected' : '' }}>
                                                    مطلق</option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="driving_license" id="driving_license"
                                                ...
                                                <option value="">اختر الحالة</option>
                                                <option value="0"
                                                    {{ old('driving_license') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('driving_license') == '1' ? 'selected' : '' }}>
                                                    نعم</option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4" id="drivingLicenseTypeGroup"
                                        @if (old('driving_license') != 1) style="display: none;" @endif>
                                        <div class="form-group">
                                            ...
                                            <select name="driving_license_type_id"
                                                ...
                                                @foreach ($driving_license_types as $driving_license_type)
                                                    <option value="{{ $driving_license_type->id }}"
                                                        {{ old('driving_license_type_id') == $driving_license_type->id ? 'selected' : '' }}>
                            ...
                            <div class="tab-pane fade" id="tab-military" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4" id="military_start_date"
                                        @if (old('military_status') != 1) style="display: none;" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4" id="military_exemption_date"
                                        @if (old('military_status') != 2) style="display: none;" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4" id="postponement_reason"
                                        @if (old('military_status') != 3) style="display: none;" @endif>
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="tab-job" role="tabpanel" aria-labelledby="tab-job-tab">
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="graduation_grade"
                                                ...
                                                <option value="1"
                                                    {{ old('graduation_grade') == '1' ? 'selected' : '' }}>
                                                    ممتاز</option>
                                                <option value="2"
                                                    {{ old('graduation_grade') == '2' ? 'selected' : '' }}>
                                                    جيد جدا</option>
                                                <option value="3"
                                                    {{ old('graduation_grade') == '3' ? 'selected' : '' }}>
                                                    جيد</option>
                                                <option value="4"
                                                    {{ old('graduation_grade') == '4' ? 'selected' : '' }}>
                                                    مقبول</option>
                                                <option value="5"
                                                    {{ old('graduation_grade') == '5' ? 'selected' : '' }}>
                                                    ضعيف</option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="employment_status"
                                                ...
                                                <option value="1"
                                                    {{ old('employment_status') == '1' ? 'selected' : '' }}>
                                                    نشط
                                                </option>
                                                <option value="0"
                                                    {{ old('employment_status') == '0' ? 'selected' : '' }}>
                                                    غير نشط
                                                </option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="fixed_shift" id="fixed_shift"
                                                ...
                                                <option value="1"
                                                    {{ old('fixed_shift') == '1' ? 'selected' : '' }}>ثابت
                                                </option>
                                                <option value="0"
                                                    {{ old('fixed_shift') == '0' ? 'selected' : '' }}>غير
                                                    ثابت
                                                </option>
                                            </select>
                                            ...
                                            <select name="resignation_id" id="resignation_id"
                                                ...
                                                @foreach ($resignations as $resignation)
                                                    <option value="{{ $resignation->id }}"
                                                        {{ old('resignation_id') == $resignation->id && old('resignation_id') !== '' ? 'selected' : '' }}>
                                                        {{ $resignation->name }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-md-4" id="resignation_date_group"
                                        @if (old('resignation_id') == '' || old('resignation_id') === null) style="display: none;" @endif>
                                        <div class="form-group">
                            ...
                            <div class="tab-pane fade" id="tab-financial" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="motivation_type" id="motivation_type"
                                                ...
                                                <option value="0"
                                                    {{ old('motivation_type') == '0' ? 'selected' : '' }}>
                                                    بدون</option>
                                                <option value="1"
                                                    {{ old('motivation_type') == '1' ? 'selected' : '' }}>
                                                    ثابت</option>
                                                <option value="2"
                                                    {{ old('motivation_type') == '2' ? 'selected' : '' }}>
                                                    متغير</option>
                                            </select>
                                            @include('admin.errors.errors', [
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="payment_method" id="payment_method"
                                                ...
                                                <option value="2"
                                                    ...
                                                    تحويل بنكي</option>
                                                <option value="3"
                                                    {{ old('payment_method') == '3' ? 'selected' : '' }}>شيك
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_social_insurance" id="has_social_insurance"
                                                ...
                                                <option value="0"
                                                    {{ old('has_social_insurance') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('has_social_insurance') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4" id="social_insurance_amount_group"
                                        @if (old('has_social_insurance') != 1) style="display: none;" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_medical_insurance" id="has_medical_insurance"
                                                ...
                                                <option value="">اختر</option>
                                                <option value="0"
                                                    {{ old('has_medical_insurance') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('has_medical_insurance') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4" id="medical_insurance_number_group"
                                        @if (old('has_medical_insurance') != 1) style="display: none;" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="fixed_allowance"
                                                ...
                                                <option value="0"
                                                    {{ old('fixed_allowance', '0') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('fixed_allowance') == '1' ? 'selected' : '' }}>
                                                    نعم</option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_attendance"
                                                ...
                                                <option value="1"
                                                    {{ old('has_attendance', '1') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                                <option value="0"
                                                    {{ old('has_attendance') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="active_for_vacation"
                                                ...
                                                <option value="0"
                                                    {{ old('active_for_vacation', '0') == '0' ? 'selected' : '' }}>
                                                    لا</option>
                                                <option value="1"
                                                    {{ old('active_for_vacation') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                            @include('admin.errors.errors', [
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_sensitive_data"
                                                ...
                                                <option value="0"
                                                    {{ old('has_sensitive_data', '0') == '0' ? 'selected' : '' }}>
                                                    لا</option>
                                                <option value="1"
                                                    {{ old('has_sensitive_data') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                            @include('admin.errors.errors', [
                            ...
                            <div class="tab-pane fade" id="tab-extra" role="tabpanel"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_disability" id="has_disability"
                                                ...
                                                <option value="">اختر</option>
                                                <option value="0"
                                                    {{ old('has_disability') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('has_disability') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4" id="disability_description_group"
                                        @if (old('has_disability') != 1) style="display: none;" @endif>
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <select name="has_relative" id="has_relative"
                                                ...
                                                <option value="">اختر</option>
                                                <option value="0"
                                                    {{ old('has_relative') == '0' ? 'selected' : '' }}>لا
                                                </option>
                                                <option value="1"
                                                    {{ old('has_relative') == '1' ? 'selected' : '' }}>نعم
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-4" id="relative_description_group"
                                        @if (old('has_relative') != 1) style="display: none;" @endif>
                                        <div class="form-group">
