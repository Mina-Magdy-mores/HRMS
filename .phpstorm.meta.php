...
'filesystems.links.C:\\xampp\\htdocs\\HRMS\\public\\storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'admin.general-settings.update','admin.general-settings.downloadImage','admin.financeCalendars.index','admin.financeCalendars.create','admin.financeCalendars.store',
'admin.financeCalendars.show','admin.financeCalendars.edit','admin.financeCalendars.update','admin.financeCalendars.destroy','admin.financeCalendars.months',
'admin.branches.index','admin.branches.create','admin.branches.store','admin.branches.edit','admin.branches.update',
'admin.branches.destroy','admin.shifts-types.index','admin.shifts-types.create','admin.shifts-types.store','admin.shifts-types.edit',
'admin.shifts-types.update','admin.shifts-types.destroy','admin.shifts-types.search','admin.departments.index','admin.departments.create',
'admin.departments.store','admin.departments.edit','admin.departments.update','admin.departments.destroy','admin.jobCategories.index',
'admin.jobCategories.create','admin.jobCategories.store','admin.jobCategories.edit','admin.jobCategories.update','admin.jobCategories.destroy',
'admin.qualifications.index','admin.qualifications.create','admin.qualifications.store','admin.qualifications.edit','admin.qualifications.update',
'admin.qualifications.destroy','admin.occasions.index','admin.occasions.create','admin.occasions.store','admin.occasions.edit',
'admin.occasions.update','admin.occasions.destroy','admin.resignations.index','admin.resignations.create','admin.resignations.store',
'admin.resignations.edit','admin.resignations.update','admin.resignations.destroy','admin.nationalities.index','admin.nationalities.create',
'admin.nationalities.store','admin.nationalities.edit','admin.nationalities.update','admin.nationalities.destroy','admin.religions.index',
'admin.religions.create','admin.religions.store','admin.religions.edit','admin.religions.update','admin.religions.destroy',
'admin.blood-groups.index','admin.blood-groups.create','admin.blood-groups.store','admin.blood-groups.edit','admin.blood-groups.update',
'admin.blood-groups.destroy','admin.countries.index','admin.countries.create','admin.countries.store','admin.countries.edit',
'admin.countries.update','admin.countries.destroy','admin.governorates.index','admin.governorates.create','admin.governorates.store',
'admin.governorates.edit','admin.governorates.update','admin.governorates.destroy','admin.cities.index','admin.cities.create',
'admin.cities.store','admin.cities.edit','admin.cities.update','admin.cities.destroy','admin.employees.index',
'admin.employees.details','admin.employees.create','admin.employees.store','admin.employees.edit','admin.employees.update',
'admin.employees.destroy','admin.employees.governorate-list','admin.employees.cities-list','admin.employees.search','admin.employees.download',
'admin.employees.add-file','admin.employees.delete','admin.employees.add-allowance','admin.employees.delete-allowance','admin.employees.update-allowance',
'admin.allowance-types.index','admin.allowance-types.create','admin.allowance-types.store','admin.allowance-types.edit','admin.allowance-types.update',
'admin.allowance-types.destroy','admin.deduction-types.index','admin.deduction-types.create','admin.deduction-types.store','admin.deduction-types.edit',
'admin.deduction-types.update','admin.deduction-types.destroy','admin.bonuses.index','admin.bonuses.create','admin.bonuses.store',
'admin.bonuses.edit','admin.bonuses.update','admin.bonuses.destroy','admin.main-salary-records.index','admin.main-salary-records.open-month',
'admin.main-salary-records.create','admin.main-salary-records.store','admin.main-salary-records.edit','admin.main-salary-records.update','admin.main-salary-records.destroy',
'admin.main-salary-records.load-open-month','admin.main-salary-employee-deductions.index','admin.main-salary-employee-deductions.show','admin.main-salary-employee-deductions.ajax-check','admin.main-salary-employee-deductions.store',
'admin.main-salary-employee-deductions.ajax-search','admin.main-salary-employee-deductions.destroy','admin.main-salary-employee-deductions.edit','admin.main-salary-employee-deductions.update','admin.main-salary-employee-deductions.print-search',
'admin.main-salary-employee-absences.index','admin.main-salary-employee-absences.show','admin.main-salary-employee-absences.ajax-check','admin.main-salary-employee-absences.store','admin.main-salary-employee-absences.ajax-search',
'admin.main-salary-employee-absences.destroy','admin.main-salary-employee-absences.edit','admin.main-salary-employee-absences.update','admin.main-salary-employee-absences.print-search','admin.main-salary-employee-additions.index',
'admin.main-salary-employee-additions.show','admin.main-salary-employee-additions.ajax-check','admin.main-salary-employee-additions.store','admin.main-salary-employee-additions.ajax-search','admin.main-salary-employee-additions.destroy',
'admin.main-salary-employee-additions.edit','admin.main-salary-employee-additions.update','admin.main-salary-employee-additions.print-search','admin.main-salary-employee-allowances.index','admin.main-salary-employee-allowances.show',
'admin.main-salary-employee-allowances.ajax-check','admin.main-salary-employee-allowances.store','admin.main-salary-employee-allowances.ajax-search','admin.main-salary-employee-allowances.destroy','admin.main-salary-employee-allowances.edit',
'admin.main-salary-employee-allowances.update','admin.main-salary-employee-allowances.print-search','admin.main-salary-employee-deduction-types.index','admin.main-salary-employee-deduction-types.show','admin.main-salary-employee-deduction-types.ajax-check',
'admin.main-salary-employee-deduction-types.store','admin.main-salary-employee-deduction-types.ajax-search','admin.main-salary-employee-deduction-types.destroy','admin.main-salary-employee-deduction-types.edit','admin.main-salary-employee-deduction-types.update',
'admin.main-salary-employee-deduction-types.print-search','admin.main-salary-employee-bonuses.index','admin.main-salary-employee-bonuses.show','admin.main-salary-employee-bonuses.ajax-check','admin.main-salary-employee-bonuses.store',
'admin.main-salary-employee-bonuses.ajax-search','admin.main-salary-employee-bonuses.destroy','admin.main-salary-employee-bonuses.edit','admin.main-salary-employee-bonuses.update','admin.main-salary-employee-bonuses.print-search',
'admin.main-salary-employee-loans.index','admin.main-salary-employee-loans.show','admin.main-salary-employee-loans.ajax-check','admin.main-salary-employee-loans.store','admin.main-salary-employee-loans.ajax-search',
'admin.main-salary-employee-loans.destroy','admin.main-salary-employee-loans.edit','admin.main-salary-employee-loans.update','admin.main-salary-employee-loans.print-search','admin.main-salary-employee-ploans.index',
'admin.main-salary-employee-ploans.ajax-check','admin.main-salary-employee-ploans.store','admin.main-salary-employee-ploans.ajax-search','admin.main-salary-employee-ploans.print-search','admin.main-salary-employee-ploans.show',
'admin.main-salary-employee-ploans.destroy','admin.main-salary-employee-ploans.edit','admin.main-salary-employee-ploans.update','admin.main-salary-employee-ploans.disbursed','admin.main-salary-employee.index',
'admin.main-salary-employee.show','admin.main-salary-employee.ajax-search','admin.main-salary-employee.print-search','admin.index','admin.login','storage.local','storage.local.upload',);
...
'admin.JobsCategories.table','admin.JobsCategories.update','admin.JobsCategories.updateForm','admin.allowanceType.create','admin.allowanceType.form',
'admin.allowanceType.index','admin.allowanceType.table','admin.allowanceType.update','admin.allowanceType.updateForm','admin.auth.login',
'admin.blood_group.create','admin.blood_group.form','admin.blood_group.index','admin.blood_group.table','admin.blood_group.update',
'admin.blood_group.updateForm','admin.bonus.create','admin.bonus.form','admin.bonus.index','admin.bonus.table',
'admin.bonus.update','admin.bonus.updateForm','admin.branches.create','admin.branches.form','admin.branches.index',
'admin.branches.table','admin.branches.update','admin.branches.updateForm','admin.city.create','admin.city.form',
'admin.city.index','admin.city.table','admin.city.update','admin.city.updateForm','admin.country.create',
'admin.country.form','admin.country.index','admin.country.table','admin.country.update','admin.country.updateForm',
'admin.dashboard','admin.deductionType.create','admin.deductionType.form','admin.deductionType.index','admin.deductionType.table',
'admin.deductionType.update','admin.deductionType.updateForm','admin.departments.create','admin.departments.form','admin.departments.index',
'admin.departments.table','admin.departments.update','admin.departments.updateForm','admin.employees.ajaxSearch','admin.employees.allowances_rows',
'admin.employees.cities_list','admin.employees.create','admin.employees.form','admin.employees.governorate_list','admin.employees.index',
'admin.employees.modal_details','admin.employees.table','admin.employees.update','admin.employees.updateForm','admin.errors.404',
'admin.errors.errors','admin.financeCalendar.create','admin.financeCalendar.form','admin.financeCalendar.index','admin.financeCalendar.months',
'admin.financeCalendar.table','admin.financeCalendar.update','admin.financeCalendar.updateForm','admin.governorate.create','admin.governorate.form',
'admin.governorate.index','admin.governorate.table','admin.governorate.update','admin.governorate.updateForm','admin.includes.content',
'admin.includes.footer','admin.includes.navbar','admin.includes.sidebar','admin.layouts.admin','admin.mainSalaryEmployee.ajaxSearch',
'admin.mainSalaryEmployee.index','admin.mainSalaryEmployee.print_search','admin.mainSalaryEmployee.show','admin.mainSalaryEmployee.show-table','admin.mainSalaryEmployee.table',
'admin.mainSalaryRecord.ajaxSearch','admin.mainSalaryRecord.index','admin.mainSalaryRecord.load_open_month','admin.mainSalaryRecord.table','admin.mainSalaryRecordAbsence.ajaxSearch',
'admin.mainSalaryRecordAbsence.index','admin.mainSalaryRecordAbsence.print_search','admin.mainSalaryRecordAbsence.show','admin.mainSalaryRecordAbsence.show-table','admin.mainSalaryRecordAbsence.table',
'admin.mainSalaryRecordAddition.ajaxSearch','admin.mainSalaryRecordAddition.index','admin.mainSalaryRecordAddition.print_search','admin.mainSalaryRecordAddition.show','admin.mainSalaryRecordAddition.show-table',
'admin.mainSalaryRecordAddition.table','admin.mainSalaryRecordAllowance.ajaxSearch','admin.mainSalaryRecordAllowance.index','admin.mainSalaryRecordAllowance.print_search','admin.mainSalaryRecordAllowance.show',
'admin.mainSalaryRecordAllowance.show-table','admin.mainSalaryRecordAllowance.table','admin.mainSalaryRecordBonus.ajaxSearch','admin.mainSalaryRecordBonus.index','admin.mainSalaryRecordBonus.print_search',
'admin.mainSalaryRecordBonus.show','admin.mainSalaryRecordBonus.show-table','admin.mainSalaryRecordBonus.table','admin.mainSalaryRecordDeduction.ajaxSearch','admin.mainSalaryRecordDeduction.index',
'admin.mainSalaryRecordDeduction.print_search','admin.mainSalaryRecordDeduction.show','admin.mainSalaryRecordDeduction.show-table','admin.mainSalaryRecordDeduction.table','admin.mainSalaryRecordDeductionType.ajaxSearch',
'admin.mainSalaryRecordDeductionType.index','admin.mainSalaryRecordDeductionType.print_search','admin.mainSalaryRecordDeductionType.show','admin.mainSalaryRecordDeductionType.show-table','admin.mainSalaryRecordDeductionType.table',
'admin.mainSalaryRecordLoan.ajaxSearch','admin.mainSalaryRecordLoan.index','admin.mainSalaryRecordLoan.print_search','admin.mainSalaryRecordLoan.show','admin.mainSalaryRecordLoan.show-table',
'admin.mainSalaryRecordLoan.table','admin.mainSalaryRecordPLoan.ajaxSearch','admin.mainSalaryRecordPLoan.index','admin.mainSalaryRecordPLoan.print_search','admin.mainSalaryRecordPLoan.show',
'admin.mainSalaryRecordPLoan.table','admin.nationality.create','admin.nationality.form','admin.nationality.index','admin.nationality.table',
'admin.nationality.update','admin.nationality.updateForm','admin.occasion.create','admin.occasion.form','admin.occasion.index',
'admin.occasion.table','admin.occasion.update','admin.occasion.updateForm','admin.qualification.create','admin.qualification.form',
'admin.qualification.index','admin.qualification.table','admin.qualification.update','admin.qualification.updateForm','admin.religion.create',
'admin.religion.form','admin.religion.index','admin.religion.table','admin.religion.update','admin.religion.updateForm',
'admin.resignations.create','admin.resignations.form','admin.resignations.index','admin.resignations.table','admin.resignations.update',
'admin.resignations.updateForm','admin.shifts-types.ajaxSearch','admin.shifts-types.create','admin.shifts-types.form','admin.shifts-types.index',
