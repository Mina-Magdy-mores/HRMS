...
'admin.jobCategories.store','admin.jobCategories.edit','admin.jobCategories.update','admin.jobCategories.destroy','admin.qualifications.index',
'admin.qualifications.create','admin.qualifications.store','admin.qualifications.edit','admin.qualifications.update','admin.qualifications.destroy',
'admin.occasions.index','admin.occasions.create','admin.occasions.store','admin.occasions.edit','admin.occasions.update',
'admin.occasions.destroy','admin.index','admin.login','storage.local',
...
'admin.layouts.admin','admin.occasion.create','admin.occasion.form','admin.occasion.index','admin.occasion.table',
'admin.occasion.update','admin.occasion.updateForm','admin.qualification.create','admin.qualification.form','admin.qualification.index',
'admin.qualification.table','admin.qualification.update','admin.qualification.updateForm','admin.shifts-types.ajaxSearch','admin.shifts-types.create',
'admin.shifts-types.form','admin.shifts-types.index','admin.shifts-types.table','admin.shifts-types.update','admin.shifts-types.updateForm',
