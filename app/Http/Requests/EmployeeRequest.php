...
class EmployeeRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'fixed_shift' => 'required|in:0,1',
            'shift_type_id' => 'nullable|required_if:fixed_shift,1|exists:shifts_types,id',
            'daily_work_hours' => 'nullable|required_if:fixed_shift,0|numeric|min:0',
    ...
    public function messages()
    {
        return [
            ...
            'fixed_shift.required' => 'حالة الشيفت مطلوبة',
            'fixed_shift.in' => 'حالة الشيفت الثابت غير صحيحة',
            'shift_type_id.required_if' => 'نوع الشيفت مطلوب',
            'shift_type_id.exists' => 'نوع الشيفت المختار غير موجود',
            'daily_work_hours.required_if' => 'عدد ساعات العمل مطلوبة',
